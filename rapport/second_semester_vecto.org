...
** Définition des NAS Benchmark parallèle
  ...
  benchmarks améliorés afin d’augmenter et d’améliorer les performances informatiques parallèles qui sont faible 
  dans les benchmarks traditionnels. Du coup, les NAS est un outil développé et amélioré pour évaluer 
  la performances des superscalculateurs.
